...
const About = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("tirouvingadamebaala@gmail.com");
    setHasCopied(true);
    setTimeout(() => {
      setHasCopied(false);
    }, 2000);
      ...
      <div className="grid xl:grid-cols-3 xl: grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
        ...
        <div className="col-span-1 xl:row-span-3">
          <div className="grid-container">
            ...
            />
            <div>
              <p className="grid-headtext"> Hi I'm Rajabaala</p>
              <p className="grid-subtext">
                I have honed my skills in Front-end
          ...
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">
                ...
                with the Java  (React.js, Node.js) to
        ...
        <div className="col-span-1 xl:row-span-4">
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">
                I&apos;i=Im based in Pondicherry , Chennai , India and open to remote
                work worldwide.
              </p>
              <a href="#contact">
                <Button
